...
- (void)slk_setupViewConstraints
{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[containerView(200@750)][typingIndicatorView(0)]-0@999-[textInputbar(0)]|" options:0 metrics:nil views:views]];
    ...
    self.scrollViewHC = [self.view slk_constraintForAttribute:NSLayoutAttributeHeight firstItem:self.scrollViewProxy secondItem:nil];
		self.scrollContainerBottomC = [self.view slk_constraintForAttribute:NSLayoutAttributeBottom firstItem:self.scrollViewContainer secondItem:nil];
